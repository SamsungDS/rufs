...
impl<T: Operations> OperationsVTable<T> {
    ...
    unsafe extern "C" fn init_request_callback(
        ...
        from_result(|| {
            ...
            // `raw_try_init` returns an error. We promise not to move the pointee of `pdu`.
            unsafe {
                pin_init::raw_try_init(RequestDataWrapper::data_ptr(pdu.as_ptr()), initializer)?
            };
    ...
    pub(crate) unsafe extern "C" fn report_zones_callback(
        ...
        // SAFETY: By function safety requirements, `disk_ptr` is a valid gendisk that stays
